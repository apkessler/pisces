...
class AquariumLightsSettingsPage(Subwindow):
    ...
    def __init__(self):
        ...
        time_setting_frame = tk.LabelFrame(
            self.master, text="Day/Night Schedule", font=fontTuple
        )
        eclipse_setting_frame = tk.LabelFrame(
            self.master, text="Periodic Blue Settings", font=fontTuple
        )
        tk.Label(
            self.master,
        ...
        tk.Label(eclipse_setting_frame, text="Interval (min)", font=big_font).grid(
            row=2, column=0
        )
        tk.Label(
        ...
        self.blue_interval_min_var.set(
    ...
    def save_settings(self):
        ...
        self.tank_light_schedule["eclipse_frequency_min"] = int(
            self.blue_interval_min_var.get()
        )
        self.tank_light_schedule["eclipse_duration_min"] = int(
            self.blue_duration_min_var.get()
        )
