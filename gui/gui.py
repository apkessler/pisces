...
class MainWindow(Window):
    ...
    def __init__(self, root, fullscreen):
        ...
        self.fert_img_small = tk.PhotoImage(
            file=os.path.join(ICON_PATH, "fert_icon.png")
        ).subsample(SCALE, SCALE)
        ...
        buttons = [
            ...
            {
                "text": "Fertilizer",
                "callback": lambda: ManualFertilizerPage(),
...
class LockScreen(Subwindow):
    ...
    def __init__(self, main_window):
        ...
        tk.Label(frame, textvariable=main_window.ph_value, font=("Arial", 35)).grid(
            row=2, column=2, padx=50
        )
...
class SettingsPage(Subwindow):
    def __init__(self):
        ...
        buttons = [
            ...
            {
                "text": "Fertilizer\nSettings",
                "callback": lambda: FertilizerSettingsPage(),
            },
...
class FertilizerSettingsPage(Subwindow):
    ...
    def save_settings(self):
        ...
        if this_time + datetime.timedelta(minutes=10) > tank_on_time:
            ...
            ErrorPromptPage(
                f"Fertilizer dispense volume cannot exceed {MAX_VOLUME_ML}mL"
            )
        else:
