...
# Create circles
gpio_indicator = [tk.Label(root, text=f"{i}", width=5, height=2, bg="gray", bd=2, relief="ridge") for i in range(11)]

aqlights = [tk.Label(root, text=f"TankLight{i+1}", width=5, height=2, bg="gray", bd=2, relief="ridge") for i in range(2)]
outlets = [tk.Label(root, text=f"Outlet{i+1}", width=5, height=2, bg="gray", bd=2, relief="ridge") for i in range(4)]
