...
_HARDWARECONTROL = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetStepperState',
    full_name='hardwarecontrol.HardwareControl.GetStepperState',
    index=9,
    containing_service=None,
    input_type=_EMPTY,
